...
class ResetPasswordLocators:
    def __init__(self, page: Page):
        ...
        self.show_new_password_button = page.locator("text=Show").nth(0)
        self.hide_new_password_button = page.locator("text=Hide").nth(0)
        self.show_confirm_password_button = page.locator("text=Show").nth(1)
        self.hide_confirm_password_button = page.locator("text=Hide").nth(1)
        ...
        self.error_otp_accept_numbers_only = page.get_by_text("OTP must contain only numbers")
